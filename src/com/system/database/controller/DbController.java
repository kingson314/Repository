...
import com.system.database.service.IDbService;
...
@Controller
@RequestMapping("/db/")
public class DbController extends BaseContorller<Db> {

	@Resource
	private IDbService userService;
	...
	public void get(){
		...
		Db user = this.userService.get(id);
	...
	public void insertUser() {
		...
		Db user=UtilConver.mapToBean(this.mapParams, Db.class);
	...
	public void login(Db user) throws Exception {
	...
	public String reset(Db user) throws Exception {
	...
	public String forget(Db user) throws Exception {
		UtilLog.logDebug(this.request.getParameter("userName") + ":" + this.request.getParameter("password"));
		Map<String, Object> mapParam = new HashMap<String, Object>();
		mapParam.put("success","FGQ");
	...
	public void newpsw(Db user) throws Exception {
		UtilLog.logDebug(this.request.getParameter("userName") + ":" + this.request.getParameter("password"));
		Map<String, Object> mapParam = new HashMap<String, Object>();
		mapParam.put("success","FGQ");
		this.print(new Result(true));
	...
	public String register(Db user) throws Exception {
		UtilLog.logDebug(this.request.getParameter("userName") + ":" + this.request.getParameter("password"));
